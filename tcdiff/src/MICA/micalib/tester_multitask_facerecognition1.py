...
NOW_SCANS = '/datasets1/bjgbiesseck/NoWDataset/NoW_Dataset/final_release_version/scans/'
NOW_PICTURES = '/datasets1/bjgbiesseck/NoWDataset/NoW_Dataset/final_release_version/iphone_pictures/'
NOW_BBOX = '/datasets1/bjgbiesseck/NoWDataset/NoW_Dataset/final_release_version/detected_face/'
STIRLING_PICTURES = '/datasets1/bjgbiesseck/Stirling/images/'

class TesterMultitaskFacerecognition1(object):
